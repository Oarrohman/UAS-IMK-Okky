	...
	<div class="logo_products">
		<div class="container">
			<div class="w3ls_logo_products_left">
				<h1><a href="#"><span>TOKO ONLINE</span>Arr Clothe's</a></h1>
			</div>
	...
	<div class="products-breadcrumb">
		<div class="container">
			<ul>
				...
				<li> Website penjualan pakaian berkualitas tinggi dan bergengsi</li>
			</ul>
		</div>
	</div>
<!-- //products-breadcrumb -->
		...
		<div class="w3l_banner_nav_right">
			<section class="slider">
				<div class="flexslider">
				 ...
				 Disini kami menjual berbagai macam merek baju mulai dari brand
				 local hingga brand internasional dengan harga yang sangat amat 
				 terjangkau.<br>
